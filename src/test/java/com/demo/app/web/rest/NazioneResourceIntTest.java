...
import com.demo.app.service.NazioneService;
...
import static com.demo.app.web.rest.TestUtil.createFormattingConversionService;
...
public class NazioneResourceIntTest {
    ...
    public void updateNazione() throws Exception {
        ...
        // Update the nazione
        Nazione updatedNazione = nazioneRepository.findById(nazione.getId()).get();
